...
/**
 * Import functionality for Extra Product Options for WooCommerce
 *
 * This class handles the import of predefined fields into the plugin.
 * It provides functionality to import all fields at once and to get the first available simple product ID.
 *
 * @since 3.0.9
 */
class EPOFW_Import {
			...
			array(
				...
				'additional_rule_data' => array(
					'1687668893' => array(
						...
						'value'     => array(
							'0' => self::get_first_simple_product_id(),
						),
					),
				),
				'general'              => array(
	...
	/**
	 * Get the first available simple product ID
	 *
	 * @return string Product ID or '0' if no simple product found
	 */
	private static function get_first_simple_product_id() {
		$args = array(
			'post_type'      => 'product',
			'post_status'    => 'publish',
			'posts_per_page' => 1,
		...
		return '0'; // Return '0' if no simple product found.
	}
}
